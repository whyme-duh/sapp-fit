...
from website.views import ai_response, client_view, client_form, custom_service_request, delete_client, gemini_response, index, BlogPostView, BlogDetailView, service_detail_view, edit_client, services
